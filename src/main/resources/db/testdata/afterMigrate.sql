...
insert into permissao (id, nome, descricao) values (3, 'ADM', 'Permite editar sistema');
...
insert into restaurante_usuario_responsavel (restaurante_id, usuario_id) values (1,1), (1,2), (1,3);
insert into restaurante_usuario_responsavel (restaurante_id, usuario_id) values (2,1), (2,2);
